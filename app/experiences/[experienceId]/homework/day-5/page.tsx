...
import { SocialsForm } from '@/components/homework/SocialsForm'

export const dynamic = 'force-dynamic'

export default function Day5HomeworkPage() {
  return (
    <div className="min-h-screen bg-dark relative overflow-hidden px-4 py-12">
      ...
      <div className="relative z-10 max-w-3xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg text-primary/70">5 Day Challenge - Final Day!</p>
        </motion.div>

      ...
      <div className="relative z-10 max-w-3xl mx-auto w-full">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black text-primary mb-6 tracking-tight">
            ...
            <span className="block text-accent mt-2">The Model</span>
          </h1>
          <p className="text-xl md:text-2xl text-primary/70 font-light max-w-xl mx-auto">
            Complete your Day 1 homework to move forward in the challenge.
          </p>
        </motion.div>
        ...
        >
          <Link href="/experiences/day1/homework/day-1">
            <motion.button
